...
fun DockEngine.applyEdit(
    ...
    when (action) {
        ...
        is LauncherShellAction.SelectDockPanelEnabled ->
            DockConfigurationEngine().setDockPanelEnabled(layout = layout, enabled = action.enabled)
        ...
        is LauncherShellAction.SelectDockAlignment ->
            DockConfigurationEngine().setDockAlignment(layout = layout, alignment = action.alignment)
