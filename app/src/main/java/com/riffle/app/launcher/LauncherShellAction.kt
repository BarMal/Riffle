...
sealed interface LauncherShellAction {
    ...
    data class SelectHomeGridMargin(
    ...
    data class SelectHomeIconSize(val sizeDp: Int) : LauncherShellAction
    ...
    data class SelectDockNotificationSlotCount(val slotCount: Int) : LauncherShellAction
    ...
    data class SelectLauncherThemeColor(
        val target: LauncherThemeColorTarget,
        val argb: Int?,
    ) : LauncherShellAction
